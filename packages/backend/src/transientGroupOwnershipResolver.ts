...
export class TransientGroupOwnershipResolver implements AuthOwnershipResolver {
  ...
  private async resolveParentGroups(groupRefs: string[]): Promise<string[]> {
    ...
    for (const groupRef of groupRefs) {
      ...
      const parentGroups = await this.resolveParentGroups(parentGroupRefs);
