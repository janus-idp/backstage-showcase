...
apply_yaml_files() {
  ...
  for key in GITHUB_APP_APP_ID GITHUB_APP_CLIENT_ID GITHUB_APP_PRIVATE_KEY GITHUB_APP_CLIENT_SECRET GITHUB_APP_WEBHOOK_URL GITHUB_APP_WEBHOOK_SECRET GITHUB_ENABLED GITHUBORG_ENABLED K8S_ENABLED KEYCLOAK_URL KEYCLOAK_REALM KEYCLOAK_CLIENT_SECRET KEYCLOAK_CLIENT_ID; do
